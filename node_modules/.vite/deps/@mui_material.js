...
var MobileStepper = React40.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime37.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [backButton, variant === "text" && (0, import_jsx_runtime37.jsxs)(React40.Fragment, {
...
var defaultIcon = (0, import_jsx_runtime42.jsx)(Star_default, {
  fontSize: "inherit"
});
...
var SnackbarContent = React49.forwardRef(function SnackbarContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime44.jsxs)(SnackbarContentRoot, {
    role,
    square: true,
    elevation: 6,
    className: clsx_default(classes.root, className),
...
var Snackbar = React50.forwardRef(function Snackbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime45.jsx)(ClickAwaySlot, {
    ...clickAwayListenerProps,
    ...
    children: (0, import_jsx_runtime45.jsx)(Root, {
      ...
      children: (0, import_jsx_runtime45.jsx)(TransitionSlot, {
        ...transitionProps,
        children: children || (0, import_jsx_runtime45.jsx)(ContentSlot, {
          ...contentSlotProps
        })
      })
    })
...
var SpeedDial = React52.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  return (0, import_jsx_runtime47.jsxs)(RootSlot, {
    ...
    children: [(0, import_jsx_runtime47.jsx)(TransitionSlot, {
      ...
      unmountOnExit: true,
      ...transitionProps,
      children: (0, import_jsx_runtime47.jsx)(SpeedDialFab, {
        color: "primary",
    ...
    }), (0, import_jsx_runtime47.jsx)(SpeedDialActions, {
      id: `${id}-actions`,
      role: "menu",
...
var SpeedDialAction = React53.forwardRef(function SpeedDialAction2(inProps, ref) {
  ...
  const fab = (0, import_jsx_runtime48.jsx)(FabSlot, {
    ...fabSlotProps,
    children: icon
  });
  if (tooltipSlotProps.open) {
    return (0, import_jsx_runtime48.jsxs)(StaticTooltipSlot, {
      ...staticTooltipSlotProps,
      ...other,
      children: [(0, import_jsx_runtime48.jsx)(StaticTooltipLabelSlot, {
  ...
  return (0, import_jsx_runtime48.jsx)(TooltipSlot, {
    ...tooltipSlotProps,
...
var Add_default = createSvgIcon((0, import_jsx_runtime49.jsx)("path", {
...
var SpeedDialIcon = React55.forwardRef(function SpeedDialIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsxs)(SpeedDialIconRoot, {
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
    ...other,
    children: [openIconProp ? formatIcon(openIconProp, classes.openIcon) : null, iconProp ? formatIcon(iconProp, classes.icon) : (0, import_jsx_runtime50.jsx)(Add_default, {
...
var Step = React58.forwardRef(function Step2(inProps, ref) {
  ...
  const newChildren = (0, import_jsx_runtime51.jsxs)(StepRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
  ...
  return (0, import_jsx_runtime51.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime51.jsxs)(React58.Fragment, {
...
var CheckCircle_default = createSvgIcon((0, import_jsx_runtime52.jsx)("path", {
...
var Warning_default = createSvgIcon((0, import_jsx_runtime53.jsx)("path", {
...
var StepIcon = React61.forwardRef(function StepIcon2(inProps, ref) {
  ...
  if (typeof icon === "number" || typeof icon === "string") {
    ...
    if (error) {
      return (0, import_jsx_runtime54.jsx)(StepIconRoot, {
        as: Warning_default,
        className,
        ref,
        ownerState,
    ...
    return (0, import_jsx_runtime54.jsxs)(StepIconRoot, {
      className,
      ref,
      ownerState,
      ...other,
      children: [_circle || (_circle = (0, import_jsx_runtime54.jsx)("circle", {
        cx: "12",
        cy: "12",
        r: "12"
      })), (0, import_jsx_runtime54.jsx)(StepIconText, {
...
var StepLabel = React62.forwardRef(function StepLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime55.jsxs)(StepLabelRoot, {
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
    ...other,
    children: [icon || StepIconSlot ? (0, import_jsx_runtime55.jsx)(StepLabelIconContainer, {
      className: classes.iconContainer,
      ownerState,
      children: (0, import_jsx_runtime55.jsx)(StepIconSlot, {
        completed,
        active,
        error,
        icon,
      ...
      ownerState,
      children: [children ? (0, import_jsx_runtime55.jsx)(LabelSlot, {
        ...labelProps,
...
var StepButton = React63.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React63.cloneElement(children, childProps) : (0, import_jsx_runtime56.jsx)(StepLabel_default, {
    ...childProps,
    children
  });
...
var StepConnector = React64.forwardRef(function StepConnector2(inProps, ref) {
  ...
  return (0, import_jsx_runtime57.jsx)(StepConnectorRoot, {
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
    ...other,
...
var StepContent = React65.forwardRef(function StepContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime58.jsx)(StepContentRoot, {
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
    ...other,
...
var Stepper = React66.forwardRef(function Stepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime59.jsx)(StepperContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime59.jsx)(StepperRoot, {
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref,
...
var SwipeArea = React67.forwardRef(function SwipeArea2(props, ref) {
  ...
  const ownerState = props;
  return (0, import_jsx_runtime60.jsx)(SwipeAreaRoot, {
...
var SwipeableDrawer = React68.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime61.jsxs)(React68.Fragment, {
    children: [(0, import_jsx_runtime61.jsx)(Drawer_default, {
      ...
      ...other
    }), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime61.jsx)(NoSsr_default, {
      children: (0, import_jsx_runtime61.jsx)(SwipeAreaSlot, {
        ...swipeAreaSlotProps
      })
    })]
  });
...
var ToggleButtonGroupContext = React69.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React70.createContext(void 0);
if (true) {
...
var ToggleButton = React71.forwardRef(function ToggleButton2(inProps, ref) {
  const {
    value: contextValue,
    ...contextProps
  } = React71.useContext(ToggleButtonGroupContext_default);
  const toggleButtonGroupButtonContextPositionClassName = React71.useContext(ToggleButtonGroupButtonContext_default);
...
var ToggleButtonGroup = React72.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
  ...
  const handleChange = React72.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React72.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
...
function useScrollTrigger(options = {}) {
  ...
  const store = React73.useRef();
  const [trigger, setTrigger] = React73.useState(() => getTrigger(store, other));
  React73.useEffect(() => {
    if (target === null) {
